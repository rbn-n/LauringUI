...
local SortBagsRightToLeft, SortBagsTooltip = SortBagsRightToLeft, SortBagsTooltip
...
local CLASSES = {
	...
	-- engineering
	{
		containers = { 23774, 23775, 30745, 67390, 60217 },
	...
	-- inscription
	{
		containers = { 39489, 44446, 70136, 67394 },
...
do
	...
	for i = 1, 10 do
		local text = gsub(format(ITEM_SPELL_CHARGES, i), '(-?%d+)(.-)|4([^;]-);', function(numberString, gap, numberForms)
			...
			local j = abs(tonumber(numberString))
			local numberForm
			if j == 1 then
				numberForm = singular
			elseif j == 2 then
