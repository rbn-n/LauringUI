...
local INFO = module:RegisterInfobar("Fps", Config.Infobar.SystemPosition)
...
local IsShiftKeyDown, IsAddOnLoaded = IsShiftKeyDown, C_AddOns.IsAddOnLoaded
...
INFO.onEnter = function(self)
	...
	local maxAddOns = Config.DB["Infobar"]["MaxAddOns"]
